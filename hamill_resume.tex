...
\usepackage[left=0.4 in,top=0.4in,right=0.4 in,bottom=0.5in]{geometry} % Document margins
\newcommand{\tab}[1]{\hspace{.2667\textwidth}\rlap{#1}} 
\newcommand{\itab}[1]{\hspace{0em}\rlap{#1}}
\name{Daniel Hamill, E.I.T.} % Your name
\address{1401 N 4th Street Apt 254, Flagstaff, AZ, 86004, USA.} % Your address
\address{+1 858 245 3485 \\ Hamill.Daniel@gmail.com}  % Your phone number and email
